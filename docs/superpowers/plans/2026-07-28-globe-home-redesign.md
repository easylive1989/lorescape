...
建立 `frontend/test/features/home/presentation/screens/globe_home_screen_test.dart`。以下是測試最終版——收斂了 code review 後補的三個覆蓋缺口：點非選中卡不開故事、無座標故事被選中不崩潰、釘點上限 7 篇但捲到更舊的仍會 focus：
