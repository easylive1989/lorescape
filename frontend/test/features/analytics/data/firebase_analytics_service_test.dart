...
void main() {
  group('firebaseParametersFor', () {
    test('given_narration_started_with_first_lifetime_true_'
    ...
    test('given_narration_started_when_to_firebase_params_then_includes_'
    ...
    test('given_narration_progress_when_to_firebase_params_then_includes_'
    ...
    test('given_narration_completed_when_to_firebase_params_then_includes_'
    ...
    test('given_narration_abandoned_when_to_firebase_params_then_'
    ...
    test('given_any_event_when_to_firebase_params_then_no_value_is_bool_'
    ...
    test('given_any_event_when_to_firebase_params_then_param_count_is_'
        'within_25', () {
      final events = <AnalyticsEvent>[
        NarrationStarted(
          narrationId: 'n1',
