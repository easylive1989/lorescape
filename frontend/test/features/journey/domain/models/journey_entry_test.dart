...
void main() {
  group('JourneyEntry.create projects Place onto SavedPlace', () {
    test('given a place with no photos, when creating an entry, '
    ...
    test('given a place with photos, when creating an entry, '
  ...
  group('JourneyEntry.fromJson legacy handling', () {
    test('given a legacy row written before story_hook existed, '
    ...
    test('given a legacy row missing trip_id, when deserialising, '
        'then tripId is null', () {
      const place = Place(
        id: 'p1',
        name: 'Test',
