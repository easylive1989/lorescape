...
void main() {
  test('given a rotation facing a point, '
  ...
  test('given a rotation facing the prime meridian on the equator, '
  ...
  test('given a point on the far hemisphere, '
      'when projecting it, '
  ...
  test('given a point exactly on the horizon, '
      'when projecting it, '
  ...
  test('given a rotation facing a point with a tilt, '
  ...
  test('given two rotations across the antimeridian, '
  ...
  test('given a rotation beyond the tilt limit, '
      'when clamping it, '
